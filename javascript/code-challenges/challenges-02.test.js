...
const raisedToTheThird = (arr) => {
  ...
  console.log(`line 9 ${localArray}`);
  return localArray;
};
raisedToTheThird(numberArray);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
------------------------------------------------------------------------------------------------ */
const stingArray =['one','two','three','four','five'];
