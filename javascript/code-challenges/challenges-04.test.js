...
------------------------------------------------------------------------------------------------ */
let stringArrayA = ['one', 'two', 'Three', 'Four'];
...
const updateAnimal = (arr, callback) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    localArray.push(callback(arr[i]));
  } return localArray;
};

updateAnimal(stringArrayA, upper);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
------------------------------------------------------------------------------------------------ */
let numberArray= [12,23,13,444,55];
