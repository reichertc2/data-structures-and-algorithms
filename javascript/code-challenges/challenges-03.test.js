...
------------------------------------------------------------------------------------------------ */
const multiArray = [1, 'one', 2, 'two', 3, 'three'];
const typeNum = (arr) => {
  // Solution code here...
  let num = arr.filter((val) => typeof(val)==='number');
  return num;
...
------------------------------------------------------------------------------------------------ */
const andArray = ['sand', 'sad', 'hand', 'and'];
const containsAnd = (arr) => {
  // Solution code here...
  let string = arr.filter((val)=> val.includes('and'));
  return string;
};
containsAnd(andArray);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
------------------------------------------------------------------------------------------------ */
const secondNumArray = [1,2,3,4,5,6];
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let array = arr.filter((num) => !forbiddenValues.includes(num));
  return array;
};

notInFirstArray(numArray,secondNumArray);
/* ------------------------------------------------------------------------------------------------
